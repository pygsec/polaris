...
```
数据结构
        《大话数据结构》                                - 适合完全0基础学习，C++编写
        《学习JavaScript数据结构与算法》第3版            - 适合完全0基础学习，JS编写
        《数据结构》(邓俊辉)                            - 经典书籍：使用C++编写  
        《数据结构与算法分析-**语言描述》                 - 经典书籍：推荐C或Java版本

算法初级
        《算法图解》                                    - 入门书籍：适合零基础入门
        《算法新解》                                    - 入门书籍：思路清晰
        《算法笔记》                                    - 算法的汇总笔记
        《算法设计与分析基础》                            - Java版算法思路总结，力荐
        《编程珠玑》                                    - 算法佳作

算法进阶
        《算法》                                       - 经典书籍：Java版算法大部头
        《算法导论》                                    - 恢弘巨制：算法经典代表作
        《计算机程序设计艺术》                            - 恢弘巨制：计算机里程碑书籍 
